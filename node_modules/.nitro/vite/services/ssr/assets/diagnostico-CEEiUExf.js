import { a as PROJECTS, n as useAuditLog, r as useProjectFilter, t as Shell } from "./Shell-C9nVmuTq.js";
import { useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertTriangle, ArrowUpRight, Calendar, Camera, CheckCircle2, ClipboardCheck, FileText, OctagonAlert, Sparkles, Users, X, Zap } from "lucide-react";
import { toast } from "sonner";
//#region src/routes/diagnostico.tsx?tsr-split=component
function DiagPage() {
	return /* @__PURE__ */ jsx(Shell, { children: /* @__PURE__ */ jsx(DiagBody, {}) });
}
function DiagBody() {
			...
			/* @__PURE__ */ jsxs("section", { children: [/* @__PURE__ */ jsx(SectionHeader, {
				...
				children: [
					...
					/* @__PURE__ */ jsx(DiagBlock, {
						tone: "ia",
						label: "Causas Raiz",
						body: /* @__PURE__ */ jsxs("ol", {
							className: "space-y-1.5 list-decimal list-inside text-xs text-zinc-200",
							children: [/* @__PURE__ */ jsx("li", { children: "Paralisação de 1h30m no fornecimento de concreto usinado no dia 21/Jul." }), /* @__PURE__ */ jsx("li", { children: "Déficit constante de 2 pedreiros em relação ao histograma planejado." })]
						})
					}),
					/* @__PURE__ */ jsx(DiagBlock, {
						tone: "warning",
						...
						body: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								...
								children: [/* @__PURE__ */ jsx(MicroStat, {
									label: "Custo Extra",
									value: "R$ 18.5K",
									tone: "warn"
								}), /* @__PURE__ */ jsx(MicroStat, {
									label: "Prazo Extra",
									value: "+5 dias",
									tone: "warn"
								})]
						...
						body: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Camera, { className: "h-3.5 w-3.5 text-amber-400" }), "Foto anexada: paralisação concreteira"]
								})
							]
						})
					})
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 text-zinc-400" }), /* @__PURE__ */ jsx(StatusIcon, { className: `h-3.5 w-3.5 ${map.tint}` })]
			}),
			/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3" }), "Ação Proposta"]
						})
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Zap, { className: "h-3 w-3" }), savings]
						})
					]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						state.status === "pending" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("button", {
							onClick: onExecute,
							...
							children: [/* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5" }), " Rejeitar"]
						})] }),
						state.status === "executing" && /* @__PURE__ */ jsx("div", {
						...
						state.status === "rejected" && /* @__PURE__ */ jsx("div", {
