import { a as PROJECTS, i as ALERTS, r as useProjectFilter, t as Shell } from "./Shell-C9nVmuTq.js";
import { useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { AlertTriangle, ArrowRight, Building2, CheckCircle2, MapPin, OctagonAlert } from "lucide-react";
import { Bar, BarChart, CartesianGrid, Legend, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
//#region src/routes/index.tsx?tsr-split=component
function Dashboard() {
	return /* @__PURE__ */ jsx(Shell, { children: /* @__PURE__ */ jsx(DashboardBody, {}) });
}
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" }), "Live · sincronizado há 34s"]
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionTitle, {
						...
						children: projects.map((p) => /* @__PURE__ */ jsx(ProjectCard, { project: p }, p.id))
					})]
				}), /* @__PURE__ */ jsxs("div", {
					className: "space-y-3",
					children: [/* @__PURE__ */ jsx(SectionTitle, {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: ["Ver diagnóstico ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
										})
									]
								})]
							})
...
function SectionTitle({ title, subtitle, live }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
			...
			children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" }), "Live"]
		})]
	});
}
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(Icon, { className: `h-4 w-4 ${tones.fg}` })
			}), /* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(ProgressRow, {
